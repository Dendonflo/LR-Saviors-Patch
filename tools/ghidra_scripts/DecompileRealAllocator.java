...
public class DecompileRealAllocator extends GhidraScript {
    static final String[] TARGETS = {"00b454a0"};

    @Override
    public void run() throws Exception {
        String outPath = "C:/Users/dendo/Documents/LR FFXIII asset streaming/ghidra_output/real_allocator_decompiled.txt";
