...
public class CheckShaderCreateSafety extends GhidraScript {
    @Override
    public void run() throws Exception {
        String outPath = "C:/Users/dendo/Documents/LR FFXIII asset streaming/ghidra_output/shader_create_safety.txt";
        PrintWriter out = new PrintWriter(outPath, "UTF-8");

        String[] targets = {"00a957a0"};
        for (String t : targets) {
            ...
            out.println("  first 16 instructions:");
