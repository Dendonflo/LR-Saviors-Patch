...
public class DecompileDispatch extends GhidraScript {
    ...
    static final String[][] TARGETS = {
        {"004b6b20", "registers_004b68e0_as_callback"},
        {"004b68e0", "the_registered_callback_itself"},
        {"00434670", "caller_of_WhiteGameMain_init"}
    };

    @Override
    public void run() throws Exception {
        String outPath = "C:/Users/dendo/Documents/LR FFXIII asset streaming/tools/ghidra_output/dispatch_decompiled.txt";
