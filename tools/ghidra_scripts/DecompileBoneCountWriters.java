...
public class DecompileBoneCountWriters extends GhidraScript {
    static final String[] TARGETS = {
        "0064b490", "0064b6f0", "006be4f0", "00a21180",
        "00aaca20", "00aad000", "00ca46f0"
    };

    @Override
    public void run() throws Exception {
        String outPath = "C:/Users/dendo/Documents/LR FFXIII asset streaming/ghidra_output/bone_count_writers_decompiled.txt";
        ...
        for (String addrStr : TARGETS) {
            ...
            for (Reference ref : refs) {
                ...
                if (!seen.containsKey(key)) { seen.put(key, true); out.println("    " + key); if (++cnt>=15) break; }
            }
