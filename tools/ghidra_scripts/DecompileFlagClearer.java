...
public class DecompileFlagClearer extends GhidraScript {
    static final String[] TARGETS = {"00aaf6f0", "00aac680"};

    @Override
    public void run() throws Exception {
        String outPath = "C:/Users/dendo/Documents/LR FFXIII asset streaming/ghidra_output/flag_clearer_decompiled.txt";
