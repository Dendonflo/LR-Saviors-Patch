...
// Full (untruncated) decompiles of the confirmed-hot animation/physics
// functions and their direct callers, plus the two allocator functions used
// for the per-bone buffers, to trace exactly what memory gets walked cold
// and how it's allocated (pool reuse vs fresh pages).
public class TraceBufferOrigins extends GhidraScript {
    static final String[] TARGETS = {
        "00a29d40", "00a29710", "00a2ada0", "00a2b9c0", "00a2df30",
        "00d19a00",
        "00aabb80", "00ab01d0"
    };
    ...
    public void run() throws Exception {
        String outPath = "C:/Users/dendo/Documents/LR FFXIII asset streaming/ghidra_output/buffer_origins_decompiled.txt";
