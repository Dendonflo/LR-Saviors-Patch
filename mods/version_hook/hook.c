...
#include "hook_parts/10b_pcss_tune.c"
...
#include "hook_parts/26_ingame_ui.c"
#include "hook_parts/26b_shadow_panel.c"
#include "hook_parts/27_shadow_pcss.c"
#include "hook_parts/28_shadow_proj.c"
#include "hook_parts/29_npc_pop.c"
